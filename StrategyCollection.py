...
class LongTrendStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.macdCross= bt.indicators.CrossOver(self.macd.lines.macd, self.macd.lines.signal)
        ...
        self.vema48 = bt.indicators.ExponentialMovingAverage(self.datas[0].volume, period=48, subplot=True)
    ...
    def stop(self):
        self.log('(MomentumLasting %2d, Expected Profit %.3f) Ending Value %.2f' %
                 (self.params.momentumLasting, self.params.expectedProfit, self.broker.getvalue()), doprint=True)
