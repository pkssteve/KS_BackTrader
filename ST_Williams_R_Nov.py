...
class WillR_Nov(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.willR = bt.indicators.WilliamsR(self.datas[0], source = 'low', period = 14)
    ...
    def RSIstatemachine(self):
        ...
        if len(self) != self.RSIState["len"]:
            ...
            #wr = 100 * (self.dataclose[0] - maxprice) / (maxprice - minprice)
            ...
            if self.RSIState["state"] == "not started":
                ...
                if self.willR[0] > -80:
                # if self.willR[0] > -100 and self.willR2[-1] < self.willR2[0] and self.willR2[0] > -80:
                # if self.willR[0] > -100 and self.willR2[-1] < self.willR2[0]:
                # if self.willR[0] > -100:  # and self.willR2[-1] < self.willR2[0]:
                    retval = 1
                ...
                if self.buyprice * 0.98 > self.dataclose[0]:
                    retval = -1
