...
COMM=0.001
CASH=100000
search_dir=`ls /Users/stevepark/PycharmProjects/KS_BackTrader/datas/KOSDAQ_1D_6/*.csv`
totalcash=0
totalgain=0

output=result_KOSDAQ2.csv
...
do
    ...
    finalcash=`btrun --csvformat btcsv --data "${file}" --strategy ST_Williams_R_Nov.py \
